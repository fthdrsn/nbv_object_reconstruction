...
class TestCandidateViews(Node):
    ...
    def run_nbv_iteration(self):
        ...
        for best_view_idx in range(len(self.all_views)):
            ...
            # Publish best view
            while self.safety_stop_active:
                self.get_logger().warn('Safety stop active, skipping NBV iteration')
    ...
    def send_goal_to_controller(self, best_view):
        ...
        try:
            ...
            goal_msg.method = int(0) #0 for focus, 1 for sampling, 2 for nopath
